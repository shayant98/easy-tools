    ...
    <Popover>
      ...
      <PopoverContent className="grid gap-4" align="start">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="type-export" checked={addJsonKey} onCheckedChange={setaddJsonKey} />
        </div>
        <div className="flex items-center justify-between">
          <Label htmlFor="type-import">Add constructor</Label>
          <Switch id="type-export" checked={addConstructor} onCheckedChange={setAddConstructor} />
        </div>
        <div className="flex items-center justify-between">
          <Label htmlFor="type-import">Auto camelcase</Label>
          <Switch id="type-export" checked={autoCamelCase} onCheckedChange={setAutoCamelCase} />
        </div>
        <div className="flex items-center justify-between">
          <Label htmlFor="type-import">Add freezed import</Label>
          <Switch id="type-export" checked={addFreezedImport} onCheckedChange={setAddFreezedImport} />
        </div>
        <div className="flex items-center justify-between">
          <Label htmlFor="type-import">Add generated parts</Label>
          <Switch id="type-export" checked={addGeneratedParts} onCheckedChange={setaddGeneratedParts} />
        </div>
      </PopoverContent>
    </Popover>
  );
