...
const Options = ({
	options: { addImport, name, addExport, camelCase },
	setOptions,
}: OptionsProps) => {
	return (
		<Popover>
					...
					<TooltipProvider>
						<Tooltip>
							...
							<TooltipContent className="max-w-[200px] bg-secondary text-secondary-foreground">
								<p>
									Replace all keys seperated by{" "}
									<span className="font-bold">underscores</span> &{" "}
									<span className="font-bold">spaces</span> with camelCase.
								</p>
							</TooltipContent>
						</Tooltip>
					</TooltipProvider>
