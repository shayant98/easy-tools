...
const CustomParentNode = (props: NodeProps<NodeParentData>) => {
	return (
		<>
			...
			<div
				className={cn(
					"relative h-full min-h-8 min-w-28 rounded border-primary border-dashed px-4 py-2 text-secondary-foreground shadow",
					{
			...
			>
				<div
					className={cn(
						"absolute font-bold text-secondary-foreground text-sm opacity-100",
						{
