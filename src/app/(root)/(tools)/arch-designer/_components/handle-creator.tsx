...
import { Position, type Node, useReactFlow, useUpdateNodeInternals, type HandleType } from "reactflow";
import { type NodeData } from "./custom-node";
import { Toggle } from "@components/ui/toggle";
import { PanelBottomDashed, PanelLeftDashed, PanelRightDashed, PanelTopDashed, Plus, Trash2 } from "lucide-react";
...
const HandleCreator = ({ node }: { node: Node<NodeData> }) => {
  ...
  return (
    <div className="grid gap-5">
      ...
      <Button disabled={node.data.handles.length >= MAX_HANDLES} variant={"secondary"} onClick={addHandle}>
