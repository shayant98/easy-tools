...
const DiagramOptions = () => {
	...
	const { getNodes, toObject, setNodes, screenToFlowPosition, setEdges } =
	...
	return (
		<Panel position="top-center">
			<div className="flex items-center justify-evenly gap-4 rounded bg-muted px-4 py-4 shadow-lg">
				<DropdownMenu>
