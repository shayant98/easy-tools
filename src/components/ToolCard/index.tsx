...
const ToolCard = ({ title, icon: Icon, subtitle, link, tags = [] }: { title: string; subtitle: string; icon: IconType; link: string; tags?: string[] }) => {
  return (
    <Link key={title} href={link}>
      <div className="flex flex-col justify-between  items-center rounded-lg bg-white dark:bg-slate-900 h-full  p-5 w-72 text-center hover:scale-105 transition duration-200 cursor-pointer">
