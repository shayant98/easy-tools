...
const Container = ({ children, errorMessage, className, style }: ContainerProps) => {
  ...
  return (
    <div style={style} className={cn(className, "relative flex flex-col  h-full overflow-auto rounded-md border border-slate-500  p-1  dark:border-slate-700 md:p-6")}>
      {children}
      <div
